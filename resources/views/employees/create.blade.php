                        ...
                        <div class="form-group col-md-6">
                            ...
                            >
                                ...
                                @foreach(App\Models\Employee::getClassifications() as $classification)
                                    <option {{ old('classification') == $classification ? 'selected' : '' }} value="{{ $classification }}">{{ $classification }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            >
                                ...
                                @foreach(App\Models\Employee::getPaymentMethods() as $payment_method)
                                    <option {{ old('payment_method') == $payment_method ? 'selected' : '' }} value="{{ $payment_method }}">{{ $payment_method }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
